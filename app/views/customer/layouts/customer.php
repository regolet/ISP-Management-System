<?php
$title = $title ?? 'Customer Portal - ISP Management System';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <span class="text-muted">
                        <a href="/customer/support" class="text-muted text-decoration-none">Support</a> | 
                        <a href="/customer/faq" class="text-muted text-decoration-none">FAQ</a>
                    </span>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkNotifications() {
            fetch('/customer/notifications/check')
