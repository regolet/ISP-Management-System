<?php
$title = 'Edit Subscription - Admin Panel';
?>
...
<div class="row mb-4">
    ...
    <div class="col-md-6 text-end">
        <div class="btn-group">
            ...
            <a href="/admin/subscriptions/<?= $subscription['id'] ?>" class="btn btn-info">
...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="/admin/subscriptions/<?= $subscription['id'] ?>" class="needs-validation" novalidate>
                    <?= csrf_field() ?>
                    <?= method_field('PUT') ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <small class="d-block text-muted">
                                        <?= htmlspecialchars($subscription['customer_code']) ?>
                                    </small>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date" 
                                   value="<?= old('start_date', date('Y-m-d', strtotime($subscription['start_date']))) ?>" 
                                   required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="end_date" name="end_date" 
                                   value="<?= old('end_date', $subscription['end_date'] ? date('Y-m-d', strtotime($subscription['end_date'])) : '') ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="installation_address" name="installation_address" 
                                  rows="3" required><?= old('installation_address', $subscription['installation_address']) ?></textarea>
                    ...
                    <div class="row g-3 mb-4">
                            ...
                            <select class="form-select" id="router_model" name="router_model" required>
                                ...
                                <?php foreach ($routers as $router): ?>
                                    <option value="<?= $router['id'] ?>" 
                                            <?= (old('router_model', $subscription['router_model']) == $router['id']) ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="router_serial" name="router_serial" 
                                   value="<?= old('router_serial', $subscription['router_serial']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="ont_model" name="ont_model">
                                ...
                                <?php foreach ($onts as $ont): ?>
                                    <option value="<?= $ont['id'] ?>" 
                                            <?= (old('ont_model', $subscription['ont_model']) == $ont['id']) ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="ont_serial" name="ont_serial" 
                                   value="<?= old('ont_serial', $subscription['ont_serial']) ?>">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="ip_type" name="ip_type" required>
                                <option value="dynamic" <?= (old('ip_type', $subscription['ip_type']) === 'dynamic') ? 'selected' : '' ?>>
                                    Dynamic IP
                                </option>
                                <option value="static" <?= (old('ip_type', $subscription['ip_type']) === 'static') ? 'selected' : '' ?>>
                                    Static IP
                                </option>
                            </select>
                        ...
                        <div class="col-md-6" id="staticIpField" style="display: none;">
                            ...
                            <input type="text" class="form-control" id="ip_address" name="ip_address" 
                                   value="<?= old('ip_address', $subscription['ip_address']) ?>">
